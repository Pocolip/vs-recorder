...
const MoveUsageTab = ({ replays, team }) => {
    ...
    // Load team movesets from Pokepaste and move usage from replays
    useEffect(() => {
        loadMoveData();
    }, [team.pokepaste, replays.length]); // Also recalculate when replays change
    ...
    // Calculate move usage directly from replays (fresh calculation)
    const calculateMoveUsageFromReplays = (replays) => {
        const moveStats = {};
